...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: " (+34) 631088806",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "nestorblr_11@hotmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    description: "EU Barcelona, Spain",
  },
];
              ...
              {info.map((item, index) => {
                return (
                  <li key={index} className="flex items-center gap-6">
                    <div className="w-[52px] h-[52px] xl:w-[72px] xl:h-[72px] bg-neutral-100 dark:bg-[#27272c] text-accent rounded-md flex items-center justify-center">
